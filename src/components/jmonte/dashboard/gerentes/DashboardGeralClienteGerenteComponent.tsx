...
export default function DashboardGeralClienteGerenteComponent(props: any) {
    ...
    async function buscaDados() {
        try {
            setLoading(true);
            let rsClientes = await serviceDashBoardVendedor.listarDashBoardGerenteClienteLista(icomp);
            ...
            console.error('Erro ao buscar dados clientes gerente:', error);
        } finally {
            setLoading(false);
        }
    }
    ...
    return (
        <>
            <style>{`
                .dashboard-clientes-gerente-card .ant-card-head {
                ...
                .dashboard-clientes-gerente-card .ant-card-body {
                    padding: 0;
                }
                .dashboard-clientes-gerente-card .ant-table-thead > tr > th {
                    padding: 10px 12px;
                }
                .dashboard-clientes-gerente-card .ant-table-tbody > tr > td {
                    padding: 8px 12px;
                    border-bottom: 1px solid #fdf0f0;
                    transition: background 0.15s;
                }
                .dashboard-clientes-gerente-card .ant-table-tbody > tr:hover > td {
                    background: #fff5f5 !important;
                }
                .dashboard-clientes-gerente-card .ant-table-tbody > tr:last-child > td {
                    border-bottom: none;
                }
                .dashboard-clientes-gerente-card .ant-pagination {
                    padding: 10px 14px;
                    margin: 0 !important;
                    background: #fafafa;
                ...
                .dashboard-clientes-gerente-card .ant-table-container {
                    border: none !important;
                }
                .cliente-gerente-btn:hover {
                    color: #B22222 !important;
                }
                .reload-btn-clientes-gerente {
                    transition: transform 0.3s, box-shadow 0.2s !important;
                }
                .reload-btn-clientes-gerente:hover {
            ...
            <div style={{ maxWidth: '520px', paddingBottom: '10px' }}>
                <Card
                    className="dashboard-clientes-gerente-card"
                    style={{
                    ...
                    extra={
                        <Button
                            className="reload-btn-clientes-gerente"
                            type="primary"
                ...
                >
                    <Skeleton active loading={loading} style={{ padding: '16px' }}>
                        ...
                        >
                            {clienteSelecionado && (
                                <DashboardGeralClienteDetalhesGerenteComponent
