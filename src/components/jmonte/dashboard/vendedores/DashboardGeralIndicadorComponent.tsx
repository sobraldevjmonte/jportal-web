...
export default function DashboardGeralIndicadorComponent(props: any) {
    ...
    async function buscaDados() {
        try {
            ...
            console.error('Erro ao buscar dados indicadores:', error);
        } finally {
            setLoading(false);
        }
    }
            ...
            title: (
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
                    <span style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                        <ApartmentOutlined style={{ fontSize: '0.9rem', opacity: 0.85 }} />
                        INDICADOR
                    </span>
                    <span style={{
                        fontSize: '0.72rem',
    ...
    return (
        <>
            <style>{`
                .dashboard-indicador-card .ant-card-head {
                ...
                .dashboard-indicador-card .ant-card-body {
                    padding: 0;
                }
                .dashboard-indicador-card .ant-table-thead > tr > th {
                    padding: 10px 12px;
                }
                .dashboard-indicador-card .ant-table-tbody > tr > td {
                    padding: 8px 12px;
                    border-bottom: 1px solid #fdf0f0;
                    transition: background 0.15s;
                }
                .dashboard-indicador-card .ant-table-tbody > tr:hover > td {
                    background: #fff5f5 !important;
                }
                .dashboard-indicador-card .ant-table-tbody > tr:last-child > td {
                    border-bottom: none;
                }
                .dashboard-indicador-card .ant-pagination {
                    padding: 10px 14px;
                    margin: 0 !important;
                    background: #fafafa;
                ...
                .dashboard-indicador-card .ant-table-bordered .ant-table-container {
                    border: none !important;
                }
                .dashboard-indicador-card .ant-table-bordered .ant-table-cell {
                    border-inline-end: none !important;
                }
                .indicador-btn:hover {
                    color: #B22222 !important;
                }
                .reload-btn-indicador {
                    transition: transform 0.3s, box-shadow 0.2s !important;
                }
                .reload-btn-indicador:hover {
            ...
            <div style={{ maxWidth: '520px', paddingBottom: '10px' }}>
                <Card
                    className="dashboard-indicador-card"
                    style={{
                    ...
                    extra={
                        <Button
                            className="reload-btn-indicador"
                            type="primary"
