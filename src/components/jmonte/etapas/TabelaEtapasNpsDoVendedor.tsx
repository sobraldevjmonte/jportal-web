...
import { Badge, Button, Dropdown, Input, Space, Spin, Table, TableColumnsType, Typography } from "antd";
import TabelaProdutosComponent from "../tabelas/TabelaProdutosComponent";
...
export default function TabelaEtapasNpsDoVendedor(props: any){
